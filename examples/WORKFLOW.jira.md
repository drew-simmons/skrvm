...
tracker:
  ...
  # Best Practice: export JIRA_API_KEY="..." in your shell profile.
  api_key: "$JIRA_API_KEY"

  # Jira Project Key slug (e.g. "PROJ")
  project_slug: "PROJ"

  # Filter tickets assigned to. Limit to Jira Account ID or leave blank.
...
resolve Jira ticket **{{ issue.identifier }}**.
